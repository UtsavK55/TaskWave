...
declare global {
  ...
  type BorderRadius = BorderBottomRadius &
    BorderTopRadius & {
  ...
  type BorderWidthsBottom = {
    [key in BorderWidthBottomKeys]: {
      borderWidth: ToNumber<RemoveBeforeSeparator<key>>;
    };
  };

  type BorderWidthLeftKeys = `wLeft_${ArrayValue<
    typeof config.borders.widths
  >}`;

  type BorderWidthsLeft = {
  ...
  type BorderWidths = BorderWidthsTop &
    BorderWidthsBottom &
    BorderWidthsLeft &
    BorderWidthsRight & {
  ...
  type Borders = BorderColors & BorderRadius & BorderWidths;
}
